function y = DemodulatorSoft(u, M, NoiseVar)
% The function has three input arguments:
% the received modulated symbol stream (u),
% the esti- mate of the noise variance in the current subframe (NoiseVar),
% and a parameter representing the modulation mode (Mode).
% Mode 1 - QPSK LTE based modulation
% Mode 2 - QAM16 LTE based modulation
% Mode 3 - QAM64 LTE based modulation
% Mode 4 - QAM256 LTE based modulation
%% Initialization
...
switch M 
    ...
    case 4
        y = step(qam256, u, NoiseVar);  
    otherwise
        error('Invalid Modulation Mode. Use {QPSK, QAM16, QAM64 or QAM256}')
end
